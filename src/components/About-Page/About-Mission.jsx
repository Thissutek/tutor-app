export default function AboutMission() {
    return(
        <section className="mx-auto px-8 py-16 lg:px-20 flex flex-col lg:flex-row items-center space-y-8 lg:space-y-0 lg:space-x-8 bg-[#4B562C] h-screen overflow-hidden">
