export default function AboutMission() {
  return (
    <section className="mx-auto px-0 py-16 pl-20 lg:w-auto lg:flex-grow flex flex-col lg:flex-row items-center lg:space-y-0 lg:space-x-8 bg-[#4B562C] h-screen overflow-hidden">
      <div className="w-full lg:w-1/2 text-center lg:text-left">
        <h2 className="text-3xl font-bold mb-4 header-style-inverse text-center">
          Our Mission
        </h2>
        <p className="text-md leading-relaxed text-style-inverse">
