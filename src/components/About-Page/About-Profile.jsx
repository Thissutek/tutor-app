    ...
    <>
      <div className="container mx-auto px-8 py-16 lg:px-20 flex flex-col gap-16">
        <section className="flex flex-col lg:flex-row items-stretch">
          <div className="lg:w-1/3 w-full mx-12">
            <img
          ...
          <div className="lg:w-2/3 w-full pl-8 flex flex-col justify-center">
            <h2 className="text-3xl md:text-3xl font-bold mb-4 header-style px-10 mx-10">
              Meet Amy
            </h2>
            <p className="text-sm md:text-base leading-relaxed text-style px-10 mx-10">
