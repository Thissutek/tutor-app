const TestimonialCard = ({ testimony_review, testimony_user }) => {
  return (
    <section className="flex">
      <div className="flex w-full max-w-3xl min-h-[80vh] mx-auto overflow-hidden rounded bg-white text-slate-500 shadow-2xl shadow-slate-200">
        <div className="relative p-3 sm:p-4 md:p-6">
          <figure className="relative z-10 ">
            ...
            <figcaption className="flex flex-col items-start gap-1 sm:gap-2 p-2 sm:p-3 md:p-6 pt-0 text-xs md:text-sm text-style">
              <span
              ...
              <div className="flex items-center gap-2 sm:gap-4 pt-1 sm:pt-2 md:pt-4 text-xs md:text-sm text-style">
                <div className="flex flex-col gap-1">
                  <span className="font-bold uppercase text-xs sm:text-sm">{testimony_user}</span>
                </div>
              </div>
            </figcaption>
          </figure>
          <svg
            aria-hidden="true"
            className="absolute left-2 sm:left-4 md:left-6 top-2 sm:top-4 md:top-6 z-0 h-8 sm:h-12 md:h-16"
            viewBox="0 0 17 12"
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
          >
