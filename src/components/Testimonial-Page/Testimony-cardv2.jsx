export default function TestimonyCardV2() {
    return (
            <>
              {/*      <!-- Component: Elevated base sized testimonial with rating stars --> */}
              <div className="container w-1/4 overflow-hidden rounded bg-white text-slate-500 shadow-2xl shadow-slate-200">
              ...
              {/*      <!-- End Elevated base sized testimonial with rating stars --> */}
            </>
          )
        }