export default function TestimonyCardV2({testimony_review, testimony_user }) {
    return (
            <>
              {/*      <!-- Component: Elevated base sized testimonial with rating stars --> */}
              <div className="container w-1/2 h-1/2 overflow-hidden rounded bg-white text-slate-500 shadow-2xl shadow-slate-200">
                <div className="relative p-6">
                  <figure className="relative z-10">
                    <blockquote className="p-6 text-lg leading-relaxed text-style">
                      <p>
                        {testimony_review}
                      </p>
                    </blockquote>
                    <figcaption className="flex flex-col items-start gap-2 p-6 pt-0 text-sm text-style">
                      <span
                      ...
                      <div className="flex items-center gap-4 pt-4 text-sm text-style">
                        <div className="flex flex-col gap-1">
                          <span className="font-bold uppercase">{testimony_user}</span>
                        </div>
                      </div>
                    </figcaption>
                  </figure>
