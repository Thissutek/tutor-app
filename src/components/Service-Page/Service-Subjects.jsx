    ...
    return(
        <section className="py-16">
            <div className="container mx-auto px-8">
                {/* Heading */}
                <h2 className="text-3xl md:text-4xl font-bold text-center mb-8">Subjects Offered</h2>

                {/* Boxes Layout */}
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 header-style">
                
                    {/* First Box */}
                    <div className="bg-white shadow-lg rounded-4xl p-6 flex flex-col justify-start items-center h-full">
