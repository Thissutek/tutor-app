  ...
  return (
    <section className="py-16">
      <div className="container mx-auto px-8">
        {/* Heading */}
        <h2 className="text-3xl header-style md:text-4xl font-bold text-center mb-8">Subjects Offered</h2>

        {/* Boxes Layout */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 px-4 lg:px-12 max-w-6xl mx-auto header-style">

          {/* First Box */}
          <div className="bg-white shadow-lg rounded-4xl p-6 flex flex-col justify-start items-center h-full w-full max-w-md md:max-w-lg lg:max-w-md xl:max-w-sm mx-auto">
